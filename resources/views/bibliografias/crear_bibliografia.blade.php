                ...
                <div class="panel-body">
					<form action="{{route('agregar.bibliografia')}}" method="POST">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <textarea name="referencia" class="form-control" id="inputRef" rows="6">Añadir Referencia</textarea>
						</div>
						<br>
						<br>
					    <div class="form-group">
						    <div class="col-sm-offset-2 col-sm-10">
						        <button type="submit" class="btn btn-primary">Agregar Bibliografía</button>
						    </div>
					    </div>
                        </div>
                    </form>
