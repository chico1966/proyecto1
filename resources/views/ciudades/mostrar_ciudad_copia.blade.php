        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
					<div align="left"><a href="{{route('lista.ciudades')}}" class="btn btn-primary btn-sm">Ir a Ciudades</a></div>
					<div align="right">
                        <a href="{{route('lista.ciudades')}}" class="btn btn-primary btn-sm">Esculturas</a>
                        <a href="{{route('lista.ciudades')}}" class="btn btn-primary btn-sm">Bibliografía</a>
                    </div>
					<br>
					<br>
					<form action="{{route('lista.ciudades')}}" method="GET">
					  {{ csrf_field() }}
						...
						<div class="col-sm-10">
						  ...
						  <!-- Son los tipos de hayazgos
						<div class="col-sm-offset-2 col-sm-10">
							<div class="checkbox-inline">
							  <label>
								<input type="checkbox" id="inputFLite" value=""> Fuentes Literarias
							  </label>
							</div>						
							<div class="checkbox-inline">
							  <label>
								<input type="checkbox" id="inputFLite" value=""> Escultura
							  </label>
							</div>						
							<div class="checkbox-inline">
							  <label>
								<input type="checkbox" id="inputFLite" value=""> Epigrafía
							  </label>
							</div>						
							<div class="checkbox-inline">
							  <label>
								<input type="checkbox" id="inputFLite" value=""> Numismática
							  </label>
							</div>						
							<div class="checkbox-inline">
							  <label>
								<input type="checkbox" id="inputFLite" value=""> Arquitectura Pública
							  </label>
							</div>						
							<div class="checkbox-inline">
							  <label>
								<input type="checkbox" id="inputFLite" value=""> Arquitectura Privada
							  </label>
							</div>						
							<div class="checkbox-inline">
							  <label>
								<input type="checkbox" id="inputFLite" value=""> Necrópolis
							  </label>
							</div>						
					    </div> -->
					    ...
					    <!-- <div class="form-group">
						    <div class="col-sm-offset-2 col-sm-10">
						        <button type="submit" class="btn btn-primary">Ir a Ciudades</button>
						    </div>
					    </div>-->
